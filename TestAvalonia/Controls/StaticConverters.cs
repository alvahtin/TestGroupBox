...
namespace FoundationLibrary.Controls
{
    static class StaticConverters
    {
        ...
        public static FuncValueConverter<OperatingSystem?, CornerRadius> OSBorderCornerRadius { get; } = new((OperatingSystem? osVersion) =>
